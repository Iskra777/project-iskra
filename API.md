...
Видаляє учасника з групи. Лише `admin`, і не можна видалити самого себе — вихід із групи це окрема майбутня дія (DEVELOPMENT_PLAN.md → "вихід з групи і передача прав адміністратора"), навмисно не змішана з цим ендпоінтом.
